...
var seq__10281_10285 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__10282_10286 = null;
var count__10283_10287 = (0);
var i__10284_10288 = (0);
while(true){
if((i__10284_10288 < count__10283_10287)){
var str_10289 = cljs.core._nth.call(null,chunk__10282_10286,i__10284_10288);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_10289})));


var G__10290 = seq__10281_10285;
var G__10291 = chunk__10282_10286;
var G__10292 = count__10283_10287;
var G__10293 = (i__10284_10288 + (1));
seq__10281_10285 = G__10290;
chunk__10282_10286 = G__10291;
count__10283_10287 = G__10292;
i__10284_10288 = G__10293;
continue;
} else {
var temp__5720__auto___10294 = cljs.core.seq.call(null,seq__10281_10285);
if(temp__5720__auto___10294){
var seq__10281_10295__$1 = temp__5720__auto___10294;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10281_10295__$1)){
var c__4550__auto___10296 = cljs.core.chunk_first.call(null,seq__10281_10295__$1);
var G__10297 = cljs.core.chunk_rest.call(null,seq__10281_10295__$1);
var G__10298 = c__4550__auto___10296;
var G__10299 = cljs.core.count.call(null,c__4550__auto___10296);
var G__10300 = (0);
seq__10281_10285 = G__10297;
chunk__10282_10286 = G__10298;
count__10283_10287 = G__10299;
i__10284_10288 = G__10300;
continue;
} else {
var str_10301 = cljs.core.first.call(null,seq__10281_10295__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_10301})));


var G__10302 = cljs.core.next.call(null,seq__10281_10295__$1);
var G__10303 = null;
var G__10304 = (0);
var G__10305 = (0);
seq__10281_10285 = G__10302;
chunk__10282_10286 = G__10303;
count__10283_10287 = G__10304;
i__10284_10288 = G__10305;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__10310 = script;
goog.object.set(G__10310,"type","text/javascript");

goog.object.set(G__10310,"onload",onload);

goog.object.set(G__10310,"onreadystatechange",onload);

return G__10310;
})();
if((opt_sourceText == null)){
var G__10311 = script__$1;
goog.object.set(G__10311,"src",src);

return G__10311;
} else {
var G__10312 = script__$1;
goog.dom.setTextContext(G__10312,opt_sourceText);
...
var path_10313 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_10313);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_10313)].join(''));
} else {
var path_10314 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_10314);

goog.object.remove(goog.dependencies_.written,path_10314);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_10314)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__10315 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__10316 = repl;
clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__10316;

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__10315;
}})()})));
});})(connected_QMARK_,repl_connection))
);
