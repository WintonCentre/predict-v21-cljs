...
var G__12578 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__12578,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__12578;
}
});
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq12580){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12581,G__12582,seq12580__$2);
});
...
var file = cljs.core.get.call(null,map__12587__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__12587__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__12587__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__12587,map__12587__$1,file,line,column){
return (function (p1__12586_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__12586_SHARP_));
});})(map__12587,map__12587__$1,file,line,column))
...
var temp__5720__auto___12589 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12589)){
var message_12590 = temp__5720__auto___12589;
...
var temp__5720__auto___12591 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___12591)){
var message_12592 = temp__5720__auto___12591;
cljs.core.println.call(null,message_12592);
} else {
}
...
var output_dir = "out";
var output_dir__$1 = (function (){var G__12593 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__12593,"/"].join('');
} else {
return G__12593;
}
})();
...
var G__12595 = exception.stack;
var G__12595__$1 = (((G__12595 == null))?null:clojure.string.split_lines.call(null,G__12595));
var G__12595__$2 = (((G__12595__$1 == null))?null:cljs.core.get.call(null,G__12595__$1,depth));
if((G__12595__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__12595__$2);
}
} else {
...
var vec__12596 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__12596,(0),null);
var column = cljs.core.nth.call(null,vec__12596,(1),null);
var vec__12599 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__12599,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__12599,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__12599,(2),null);
...
var m__$1 = (function (){var G__12602 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__12606 = (function (){var G__12605 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__12605);
} else {
return G__12605;
}
})();
...
return cljs.core.vary_meta.call(null,G__12607,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__12611 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__12611,(0),null);
var types = vec__12611;
...
return cljs.core.map.call(null,(function (p__12614){
var vec__12615 = p__12614;
var ns = cljs.core.nth.call(null,vec__12615,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__12615,(1),null);
return ((function (vec__12615,ns,vars__$1){
return (function (){
...
var G__12618 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
var G__12618__$1 = (((G__12618 instanceof cljs.core.Keyword))?G__12618.fqn:null);
switch (G__12618__$1) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1){
return (function (){
var seq__12619 = cljs.core.seq.call(null,vars__$1);
var chunk__12620 = null;
var count__12621 = (0);
var i__12622 = (0);
while(true){
if((i__12622 < count__12621)){
var v = cljs.core._nth.call(null,chunk__12620,i__12622);
var temp__5720__auto___12624 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___12624)){
var t_12625 = temp__5720__auto___12624;
each_fixture_fn.call(null,((function (seq__12619,chunk__12620,count__12621,i__12622,t_12625,temp__5720__auto___12624,v,each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12625)));
});})(seq__12619,chunk__12620,count__12621,i__12622,t_12625,temp__5720__auto___12624,v,each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1))
);
} else {
}


var G__12626 = seq__12619;
var G__12627 = chunk__12620;
var G__12628 = count__12621;
var G__12629 = (i__12622 + (1));
seq__12619 = G__12626;
chunk__12620 = G__12627;
count__12621 = G__12628;
i__12622 = G__12629;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__12619);
if(temp__5720__auto__){
var seq__12619__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__12619__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__12619__$1);
var G__12630 = cljs.core.chunk_rest.call(null,seq__12619__$1);
var G__12631 = c__4550__auto__;
var G__12632 = cljs.core.count.call(null,c__4550__auto__);
var G__12633 = (0);
seq__12619 = G__12630;
chunk__12620 = G__12631;
count__12621 = G__12632;
i__12622 = G__12633;
continue;
} else {
var v = cljs.core.first.call(null,seq__12619__$1);
var temp__5720__auto___12634__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___12634__$1)){
var t_12635 = temp__5720__auto___12634__$1;
each_fixture_fn.call(null,((function (seq__12619,chunk__12620,count__12621,i__12622,t_12635,temp__5720__auto___12634__$1,v,seq__12619__$1,temp__5720__auto__,each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_12635)));
});})(seq__12619,chunk__12620,count__12621,i__12622,t_12635,temp__5720__auto___12634__$1,v,seq__12619__$1,temp__5720__auto__,each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1))
);
} else {
}


var G__12636 = cljs.core.next.call(null,seq__12619__$1);
var G__12637 = null;
var G__12638 = (0);
var G__12639 = (0);
seq__12619 = G__12636;
chunk__12620 = G__12637;
count__12621 = G__12638;
i__12622 = G__12639;
continue;
}
} else {
...
});})(each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1))
);
});})(each_fixture_fn,G__12618,G__12618__$1,env,once_fixtures,each_fixtures,vec__12615,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__12618__$1)].join('')));

}
})());
});
;})(vec__12615,ns,vars__$1))
